...
<head>
    ...
    <title>Sneaky 403! Andrew McCluckie / Web Designer and Developer</title>
...
<p id="copyright_notice">&copy; 2011 Andrew M<sup>c</sup>Cluckie</p>
      ...
      <div id="content">
                <h1>Achtung, verboten!</h1>
                <p>You naughty monkey! Trying to sneak a look at something youre not allowed to eh?. Well no dice matey. Perhaps you would like to the <a href="index.php">home page</a>. Alternatively you can use the navigation to the left, but I&rsquo;m sure you knew that already.</p>
